...
if __name__ == '__main__':
    aparser = argparse.ArgumentParser(description='Combine The Templates')
    aparser.add_argument('--input_dir', help='Input Data Directory', default='Templates/')
    aparser.add_argument('--output_dir', help='Output Data Directory', default='Combined_Templates/')
